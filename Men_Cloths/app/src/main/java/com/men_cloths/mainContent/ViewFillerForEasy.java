...
public class ViewFillerForEasy extends RelativeLayout{
    ...
    RelativeLayout.LayoutParams layoutParams1,layoutParams2,layoutParam;
    ...
    public ViewFillerForEasy(Context context, AttributeSet attrs) {
        ...
        layoutParams1=new  RelativeLayout.LayoutParams(482,
                562);
        layoutParams1.addRule(RelativeLayout.ALIGN_PARENT_LEFT);
        left.setLayoutParams(layoutParams1);

        layoutParams2=new  RelativeLayout.LayoutParams(482,
                562);
        layoutParams2.addRule(RelativeLayout.ALIGN_PARENT_RIGHT);
        right.setLayoutParams(layoutParams2);

        layoutParam=new  RelativeLayout.LayoutParams(482,
                562);
